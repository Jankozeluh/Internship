...
@section('content')
    <div class="container" style="width: 50%">
        <div class="row">
            ...
            @endif
            <div class="col-sm">
                <form action="/subjects/{{$subject->id}}/student/{{$student->id}}/end/submit" method="POST"
                      class="px-4 py-3" style="text-align: center">
                    @csrf
                    <h4 style="text-align: center">{{$subject->name}}</h4>
                    <div class="input-group input-group-sm mb-3">
                        <div style="margin: auto">
                            <label for="st">{{$student->degree.$student->firstName.$student->lastName}}</label>
