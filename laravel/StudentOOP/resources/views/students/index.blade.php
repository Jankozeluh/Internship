...
{{--                        <th>@sortablelink('groups.code', 'code')</th>--}}
                    ...
                    @foreach($student as $st)
                        <tr>
                            ...
                            <td>{{$st->credits}}</td>
                            <td>
                                <form action="/students/{{$st->id}}/delete/subject" method="POST">
                                    @csrf
                                        @foreach($st->subjects as $item)
                                            <button type="submit" id="lddButton" name="subId" value="{{$item->id}}">{{$item->name}}</button>
                                        @endforeach
                                    <a href="students/{{$st->id}}/add/subject"><svg xmlns="http://www.w3.org/2000/svg" style="margin-top: -3px" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/><path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/></svg></a>
                                </form>
                            </td>
                            <td style="border-left: solid 1px #000;"><a href="students/{{$st->id}}/edit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16"><path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/></svg></a></td>
                            ...
                            <td style="border-left: solid 1px #000;">
                                <form action="/students/{{$st->id}}/leave" method="POST">
                                    @csrf
                                    <button type="submit" id="iddButton"><svg xmlns="http://www.w3.org/2000/svg" style="margin-top: -7px" width="24" height="24" fill="currentColor" class="bi bi-skip-end-circle" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/><path d="M6.271 5.055a.5.5 0 0 1 .52.038L9.5 7.028V5.5a.5.5 0 0 1 1 0v5a.5.5 0 0 1-1 0V8.972l-2.71 1.935A.5.5 0 0 1 6 10.5v-5a.5.5 0 0 1 .271-.445z"/></svg></button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
    ...
    <div class="container" style="width: 10%; text-align: center">
        <div class="row">
            <button name="insert" class="btn btn-secondary"><a href="/students/create" style="color: white">Create</a></button>
        </div>
    </div>
@endsection
