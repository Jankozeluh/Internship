...
@section('content')
    <div class="container" style="text-align: center">
        <div class="row">
            <div class="col-sm">
                <form action="/teachers/{{$teacher->id}}/add/subject/submit" method="POST" class="px-4 py-3" style="display: flex;justify-content: center;align-items: center;flex-direction: column">
                    @csrf
