...
class SubjectController extends Controller
{
    ...
    {
        return view('subjects.create')->with('teacher',Teacher::all());
    }
    ...
    public function teacher(Subject $subject){
        $teachers = Teacher::whereDoesntHave('subjects', function ($query) use ($subject) {$query->where('subject_id', $subject->id);})->get();
